...
const BookingPage = () => {
  ...
  return (
    <div>
      <button style={bookArticleButtonStyle} >
        + Book Article Button 
      </button>
      <button style={selectMonthDropdownStyle} >
        Select Month <svg xmlns="http://www.w3.org/2000/svg" width="50" height="51" viewBox="0 0 50 51" fill="none">
